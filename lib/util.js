...
function drawExpandButton (parent, x, y, radius, plus, normalStyle, hoverStyle, predecessors) {
  var g = parent.insert("g").classed(predecessors ? "predecessorsExpandButton" : "successorsExpandButton", true).attr("transform", "translate(" + x + "," + y +")");
