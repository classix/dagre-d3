...
function calcPoints(g, e) {
  ...
  var lastPoint = intersectNode(head, points[points.length - 1]);
  
  //points.unshift({x: firstPoint.x + 10, y: firstPoint.y + 10});
  points.unshift(firstPoint);
  //points.push({x: lastPoint.x + 10, y: lastPoint.y + 10});
