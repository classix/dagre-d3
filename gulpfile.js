...
gulp.task("js:copy", function () {
    return gulp.src("build/dist/dagre-d3.min.js")
    .pipe(gulp.dest("../../../classix/Main/WebWidgets/dependencies/"));
});
...
function makeJsBundleTask(watch) {
    return makeBundleTask("./index.js", "dagre-d3.js", watch, {
        ...
        exclude: ["node_modules/lodash/lodash.js", "node_modules/d3/index.js", "node_modules/d3/build/d3.js"],
        debug: true
    });
}
...
function makeBundleTask(src, name, watch, args) {
    ...
    if (args.exclude) {
      args.exclude.forEach(function (f) {
        bundler = bundler.exclude(f);
      });
    }
